...
__host__ int run(int argc, char **argv)
{
  ...
  /* [BEGIN] Device memory allocation and stream */
  ...
  /* [END] Device memory allocation and stream */
...
template __host__ int run<at::Half>(int argc, char **argv);
